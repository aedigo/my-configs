...
myLayoutHook = avoidStruts $ mouseResize $ windowArrange $ T.toggleLayouts floats
             ...
             where
               myDefaultLayout =     withBorder myBorderWidth magnify
                                 ||| noBorders monocle
                                 ||| tall
                                 ||| floats
                                 ||| noBorders tabs
...
myKeys =
    ...
    -- KB_GROUP Windows navigation
        ...
        , ("M-p", windows W.focusUp)      -- Move focus to the prev window
        , ("M-S-m", windows W.swapMaster) -- Swap the focused window and the master window
        , ("M-S-n", windows W.swapDown)   -- Swap focused window with next window
        , ("M-S-p", windows W.swapUp)     -- Swap focused window with prev window
