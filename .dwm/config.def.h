...
#        { "Steam",    "Steam",    "Steam",    1 << 7,       0,           -1,      0,0,1360,768,      0 },
	...
	/*    class      instance    title       tags mask     isfloating   monitor    float x,y,w,h         floatborderpx*/
        ...
        { "Firefox",  NULL,       NULL,       1 << 0,       0,           -1,      50,50,500,500,        0 },
        { "aws",      "aws",      "aws",      0,            1,           -1,      500,100,600,600,      0 },
        { "Whatsapp-for-linux",   NULL,       "WhatsApp for Linux",         0,            1,           -1,      200,100,1000,600,      2 },
        { "Safeeyes", "safeeyes", "SafeEyes-0", 0,          1,           -1,      500,100,1360,768,      0 },
        { "Safeeyes", "safeeyes", "Safe Eyes",  0,          1,           -1,      450,100,800,600,      2 },
        ...
        { NULL,       "spterm",   NULL,       SPTAG(0),     1,           -1, 	    0,0,1200,300, 2},
        { NULL,       "spfm",     NULL,       SPTAG(1),     1,           -1, 	    50,50,800,600, 0},
        { NULL,       "btop",     NULL,       SPTAG(2),     1,           -1, 	    50,50,800,600, 0},
};
...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_f,      togglefullscr,  {0} },
	...
	{ MODKEY2|ShiftMask,            XK_f,      togglefloating, {0} },
