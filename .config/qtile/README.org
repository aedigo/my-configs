...
#+end_src
* Keybindings
The [[https://tools.suckless.org/dmenu/scripts/dmenu_run_with_command_history/][dmenu_history]] is a script that sort by the recently used apps. I use the aur dmenu2 package.
#+begin_src python
keys = [
    # Window Management
