...
// @name:ar Ù…Ø§Ù†Ø¹ Ø§Ù„Ù†ÙˆØ§ÙØ° Ø§Ù„Ù…Ù†Ø¨Ø«Ù‚Ø© AdGuard
// @name:be Ð‘Ð»Ð°ÐºÐ°Ð²Ð°Ð»ÑŒÐ½Ñ–Ðº ÑƒÑÐ¿Ð»Ñ‹Ð²Ð°Ð»ÑŒÐ½Ð°Ð¹ Ñ€ÑÐºÐ»Ð°Ð¼Ñ‹ Ð°Ð´ AdGuard
// @name:cs AdGuard blokÃ¡tor vyskakovacÃ­ch oken
// @name:da AdGuard Popup Blocker
// @name:de AdGuard Pop-up-Blocker
// @name:es AdGuard Popup Blocker
// @name:fa Ù…Ø³Ø¯ÙˆØ¯Ø³Ø§Ø² Ù¾Ø§Ù¾-Ø¢Ù¾ AdGuard
// @name:fi AdGuardin Ponnahdusikkunan estÃ¤jÃ¤
// @name:fr Bloqueur de fenÃªtres pop-up de AdGuard
// @name:id Pemblokir Popup AdGuard
// @name:it Blocco Pop-Up di AdGuard
// @name:ja AdGuard ãƒãƒƒãƒ—ã‚¢ãƒƒãƒ—ãƒ–ãƒ­ãƒƒã‚«ãƒ¼
// @name:ko AdGuard íŒì—… ì°¨ë‹¨ê¸°
// @name:lt AdGuard iÅ¡Å¡okanÄiÅ³jÅ³ langÅ³ blokatorius
// @name:ms AdGuard Penyekat Pop Timbul
// @name:no AdGuards popup-blokkerer
// @name:pl Bloker wyskakujÄ…cych okienek przez AdGuard
// @name:pt AdGuard Bloqueador de Pop-ups
// @name:pt-PT Bloqueador de Popup AdGuard
// @name:ru Ð‘Ð»Ð¾ÐºÐ¸Ñ€Ð¾Ð²Ñ‰Ð¸Ðº Ð²ÑÐ¿Ð»Ñ‹Ð²Ð°ÑŽÑ‰ÐµÐ¹ Ñ€ÐµÐºÐ»Ð°Ð¼Ñ‹ Ð¾Ñ‚ AdGuard
// @name:sl AdGuard Zaviralec pojavnih oken
// @name:tr AdGuard Popup Blocker eklentisi
// @name:uk Ð‘Ð»Ð¾ÐºÑƒÐ²Ð°Ð»ÑŒÐ½Ð¸Ðº ÑÐ¿Ð»Ð¸Ð²Ð°ÑŽÑ‡Ð¾Ñ— Ñ€ÐµÐºÐ»Ð°Ð¼Ð¸ AdGuard
// @name:vi AdGuard Popup Blocker
// @name:zh AdGuard å¼¹çª—æ‹¦æˆªå™¨
// @name:zh-TW AdGuard å½ˆå‡ºå¼è¦–çª—å°éŽ–å™¨
// @namespace adguard
// @description Blocks popup ads on web pages
// @description:ar Ù„Ø­Ø¸Ø± Ø§Ù„Ø¥Ø¹Ù„Ø§Ù†Ø§Øª Ø§Ù„Ù…Ù†Ø¨Ø«Ù‚Ø© Ø¹Ù„Ù‰ ØµÙØ­Ø§Øª Ø§Ù„ÙˆÙŠØ¨
// @description:be Ð‘Ð»Ð°ÐºÑƒÐµ ÑžÑÐ¿Ð»Ñ‹Ð²Ð°Ð»ÑŒÐ½ÑƒÑŽ Ñ€ÑÐºÐ»Ð°Ð¼Ñƒ Ð½Ð° ÑÑ‚Ð°Ñ€Ð¾Ð½ÐºÐ°Ñ…
// @description:cs Blokuje vyskakovacÃ­ reklamy na webovÃ½ch strÃ¡nkÃ¡ch
// @description:da Blokerer pop-up reklamer pÃ¥ websider
// @description:de Blockiert Anzeige-Pop-ups auf Webseiten
// @description:es Bloquea anuncios emergentes en sitios web
// @description:fa Ù…Ø³Ø¯ÙˆØ¯Ø³Ø§Ø²ÛŒ ØªØ¨Ù„ÛŒØºØ§Øª Ù¾Ø§Ù¾ Ø¢Ù¾ Ø¯Ø± ØµÙØ­Ø§Øª ÙˆØ¨.
// @description:fi EstÃ¤Ã¤ ponnahdusikkunamainokset verkkosivustoilla
// @description:fr Bloque les fenÃªtres pop-up avec publicitÃ©s intrusives sur les pages web
// @description:id Blokir iklan popup di halaman web
// @description:it Blocca gli annunci di popup nelle pagine internet
// @description:ja Webãƒšãƒ¼ã‚¸ã§ãƒãƒƒãƒ—ã‚¢ãƒƒãƒ—åºƒå‘Šã‚’ãƒ–ãƒ­ãƒƒã‚¯ã—ã¾ã™ã€‚
// @description:ko ì›¹ íŽ˜ì´ì§€ì—ì„œ íŒì—… ê´‘ê³ ë¥¼ ì°¨ë‹¨
// @description:lt Blokuoja iÅ¡Å¡okanÄius skelbimus tinklalapiuose
// @description:ms Sekat pop timbul pada laman web
// @description:no Blokker popup-annonser pÃ¥ nettsider
// @description:pl Blokuje wyskakujÄ…ce okienka na stronach internetowych
// @description:pt Bloqueia anÃºncios pop-ups dentro dos sites
// @description:pt-PT Bloqueia anÃºncios popup em pÃ¡ginas da web.
// @description:ru Ð‘Ð»Ð¾ÐºÐ¸Ñ€ÑƒÐµÑ‚ Ð²ÑÐ¿Ð»Ñ‹Ð²Ð°ÑŽÑ‰ÑƒÑŽ Ñ€ÐµÐºÐ»Ð°Ð¼Ñƒ Ð½Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°Ñ…
// @description:sl Blokira pojavne oglase na spletnih straneh
// @description:tr Web sayfalarÄ±nda aÃ§Ä±lan pencere reklamlarÄ± engeller
// @description:uk Ð‘Ð»Ð¾ÐºÑƒÑ” ÑÐ¿Ð»Ð¸Ð²Ð°ÑŽÑ‡Ñƒ Ñ€ÐµÐºÐ»Ð°Ð¼Ñƒ Ð½Ð° Ð²ÐµÐ±-ÑÑ‚Ð¾Ñ€Ñ–Ð½ÐºÐ°Ñ…
// @description:vi Cháº·n quáº£ng cÃ¡o báº­t lÃªn trÃªn cÃ¡c trang eb
// @description:zh æ‹¦æˆªç½‘é¡µå¼¹çª—å¹¿å‘Š
// @description:zh-TW å°éŽ–æ–¼ç¶²é ä¸Šä¹‹å½ˆå‡ºå¼è¦–çª—å»£å‘Š
// @version 2.5.62
...
options:"Options",silence_noti:"Don't show this message on {$origDomain}"},ar:{userscript_name:"Ù…Ø§Ù†Ø¹ Ø§Ù„Ù†ÙˆØ§ÙØ° Ø§Ù„Ù…Ù†Ø¨Ø«Ù‚Ø© AdGuard",on_navigation_by_popunder:"Ù…Ù† Ø§Ù„Ù…Ø­ØªÙ…Ù„ Ø§Ù† ÙŠÙƒÙˆÙ† Ù‡Ø°Ø§ Ø§Ù„Ø§Ù†ØªÙ‚Ø§Ù„ Ø¥Ù„Ù‰ Ø§Ù„ØµÙØ­Ø© Ø§Ù„Ø¬Ø¯ÙŠØ¯Ø© Ù†Ø§ØªØ¬Ø§ Ø¹Ù† Ø§Ù„Ø¥Ø·Ø§Ø± Ø§Ù„Ù…Ù†Ø¨Ø«Ù‚. Ù‡Ù„ ØªØ±ØºØ¨ ÙÙŠ Ø§Ù„Ù…ØªØ§Ø¨Ø¹Ø© ØŸ",aborted_popunder_execution:"Ù…Ø§Ù†Ø¹ Ø§Ù„Ù†ÙˆØ§ÙØ° Ø§Ù„Ù…Ù†Ø¨Ø«Ù‚Ø© Ø§Ø­Ø¨Ø· ØªÙ†ÙÙŠØ° script Ù„Ù…Ù†Ø¹ Ø£Ø¹Ø§Ø¯Ù‡ ØªÙˆØ¬ÙŠÙ‡ Ø§Ù„Ø®Ù„ÙÙŠØ©",settings_saved:"Ø§Ù„Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª Ø§Ù„Ù…Ø­ÙÙˆØ¸Ø©",show_popup:"{$destUrl}Ø§Ø¸Ù‡Ø§Ø±",continue_blocking:"Ù…ØªØ§Ø¨Ø¹Ø© Ø§Ù„Ø­Ø¸Ø±",allow_from:"{$origDomain}Ø§Ù„Ø³Ù…Ø§Ø­ Ø¨Ø§Ù„Ù†ÙˆØ§ÙØ° Ø§Ù„Ù…Ù†Ø¨Ø«Ù‚Ø© Ø¹Ù„Ù‰",manage_pref:"...Ø£Ø¯Ø§Ø±Ù‡ Ø§Ù„ØªÙØ¶ÙŠÙ„Ø§Øª",
popup_text:"Ø§Ù„Ù†ÙˆØ§ÙØ°Ø§Ù„Ù…Ù†Ø¨Ø«Ù‚Ø©{$numPopup} Ù…Ù†Ø¹ Ø§Ø¯Ø¬Ø§Ø±Ø¯ Ù…ÙˆÙ‚Ø¹ Ø§Ù„ÙˆÙŠØ¨ Ù‡Ø°Ø§ Ù…Ù† ÙØªØ­",options:"Ø§Ù„Ø®ÙŠØ§Ø±Ø§Øª",silence_noti:"{$origDomain}Ø¹Ø¯Ù… Ø¥Ø¸Ù‡Ø§Ø± Ù‡Ø°Ù‡ Ø§Ù„Ø±Ø³Ø§Ù„Ø© Ø¹Ù„Ù‰"},be:{userscript_name:"Ð‘Ð»Ð°ÐºÐ°Ð²Ð°Ð»ÑŒÐ½Ñ–Ðº ÑƒÑÐ¿Ð»Ñ‹Ð²Ð°Ð»ÑŒÐ½Ð°Ð¹ Ñ€ÑÐºÐ»Ð°Ð¼Ñ‹ Ð°Ð´ AdGuard",on_navigation_by_popunder:"Ð“ÑÑ‚Ñ‹ Ð¿ÐµÑ€Ð°Ñ…Ð¾Ð´ Ð½Ð° Ð½Ð¾Ð²ÑƒÑŽ ÑÑ‚Ð°Ñ€Ð¾Ð½ÐºÑƒ Ð½Ð°Ð¹Ñ…ÑƒÑ‚Ñ‡ÑÐ¹ Ð²Ñ‹ÐºÐ»Ñ–ÐºÐ°Ð½Ñ‹ Ð¿Ð¾Ð¿-Ð°Ð½Ð´ÑÑ€Ð°Ð¼. Ð£ÑÑ‘ Ð°Ð´Ð½Ð¾ Ð¿Ñ€Ð°Ñ†ÑÐ³Ð½ÑƒÑ†ÑŒ?",aborted_popunder_execution:"Ð‘Ð»Ð°ÐºÐ°Ð²Ð°Ð»ÑŒÐ½Ñ–Ðº ÑƒÑÐ¿Ð»Ñ‹Ð²Ð°Ð»ÑŒÐ½Ð°Ð¹ Ñ€ÑÐºÐ»Ð°Ð¼Ñ‹ Ð¿ÐµÑ€Ð°Ð¿Ñ‹Ð½Ñ–Ñž Ð²Ñ‹ÐºÐ°Ð½Ð°Ð½Ð½Ðµ ÑÐºÑ€Ñ‹Ð¿Ñ‚Ñƒ, ÐºÐ°Ð± Ð¿ÐµÑ€Ð°Ð´ÑƒÑ…Ñ–Ð»Ñ–Ñ†ÑŒ Ñ„Ð¾Ð½Ð°Ð²Ð°Ðµ Ð¿ÐµÑ€Ð°Ð°Ð´Ñ€Ð°ÑÐ°Ð²Ð°Ð½Ð½Ðµ",settings_saved:"ÐÐ°Ð»Ð°Ð´Ñ‹ Ð·Ð°Ñ…Ð°Ð²Ð°Ð½Ñ‹",show_popup:"ÐŸÐ°ÐºÐ°Ð·Ð°Ñ†ÑŒ {$destUrl}",
continue_blocking:"ÐŸÑ€Ð°Ñ†ÑÐ³Ð½ÑƒÑ†ÑŒ Ð±Ð»Ð°ÐºÐ°Ð²Ð°Ð½Ð½Ðµ",allow_from:"Ð”Ð°Ð·Ð²Ð¾Ð»Ñ–Ñ†ÑŒ ÑƒÑÐ¿Ð»Ñ‹Ð²Ð°Ð»ÑŒÐ½Ñ‹Ñ Ð²Ð¾ÐºÐ½Ñ‹ Ð½Ð° {$origDomain}",manage_pref:"ÐšÑ–Ñ€Ð°Ð²Ð°Ñ†ÑŒ Ð½Ð°Ð»Ð°Ð´Ð°Ð¼Ñ–...",popup_text:"AdGuard Ð·Ð°Ð¿Ð°Ð±ÐµÐ³ Ð¿Ð°ÐºÐ°Ð· {$numPopup} ÑƒÑÐ¿Ð»Ñ‹Ð²Ð°Ð»ÑŒÐ½Ñ‹Ñ… Ð²Ð¾ÐºÐ½Ð°Ñž Ð½Ð° Ð³ÑÑ‚Ñ‹Ð¼ ÑÐ°Ð¹Ñ†Ðµ",options:"ÐžÐ¿Ñ†Ñ‹Ñ–",silence_noti:"ÐÐµ Ð¿Ð°ÐºÐ°Ð·Ð²Ð°Ñ†ÑŒ Ð³ÑÑ‚Ð° Ð¿Ð°Ð²ÐµÐ´Ð°Ð¼Ð»ÐµÐ½Ð½Ðµ Ð½Ð° {$origDomain}"},cs:{userscript_name:"AdGuard blokÃ¡tor vyskakovacÃ­ch oken",on_navigation_by_popunder:"Tento pÅ™echod na novou strÃ¡nku bude pravdÄ›podobnÄ› zpÅ¯soben pop-under. Chcete pokraÄovat?",aborted_popunder_execution:"BlokÃ¡tor vyskakovacÃ­ch oken zruÅ¡il spuÅ¡tÄ›nÃ­ skriptu, aby zabrÃ¡nil pÅ™esmÄ›rovÃ¡nÃ­ na pozadÃ­",
settings_saved:"NastavenÃ­ uloÅ¾ena",show_popup:"Zobrazit {$destUrl}",continue_blocking:"PokraÄovat v blokovÃ¡nÃ­",allow_from:"Povolit vyskakovacÃ­ okna na {$origDomain}",manage_pref:"Spravovat pÅ™edvolby",popup_text:"AdGuard zabrÃ¡nil tomu, aby tato webovÃ¡ strÃ¡nka otevÅ™ela vyskakovacÃ­ okna: {$numPopup}",options:"MoÅ¾nosti",silence_noti:"Tuto zprÃ¡vu nezobrazovat na {$origDomain}"},da:{userscript_name:"AdGuard Popup Blocker",on_navigation_by_popunder:"Denne overgang til den nye side vil sandsynligvis medfÃ¸re et pop under-vindue. Ã˜nsker du at fortsÃ¦tte?",
aborted_popunder_execution:"Popup Blocker afbrÃ¸d en script eksekvering for at forhindre baggrundsomdirigering",settings_saved:"Indstillingerne er gemt",show_popup:"Vis {$destUrl}",continue_blocking:"FortsÃ¦t blokering",allow_from:"Tillad pop-ups pÃ¥ {$origDomain}",manage_pref:"Administrer prÃ¦ferencer...",popup_text:"AdGuard forhindrede denne hjemmeside i at Ã¥bne {$numPopup} pop op-vinduer",options:"Valgmuligheder",silence_noti:"Vis ikke denne meddelelse pÃ¥ {$origDomain}"},de:{userscript_name:"AdGuard Pop-up-Blocker",
on_navigation_by_popunder:"Diese Seiten-Navigation wird wahrscheinlich durch ein Pop-under verursacht. MÃ¶chten Sie fortfahren?",aborted_popunder_execution:"Pop-up-Blocker hat eine Skript-AusfÃ¼hrung abgebrochen, um eine Hintergrundumleitung zu verhindern",settings_saved:"Einstellungen gespeichert",show_popup:"{$destUrl} anzeigen",continue_blocking:"Blockieren fortsetzen",allow_from:"Pop-ups auf {$origDomain} zulassen",manage_pref:"Einstellungen verwalten...",popup_text:"AdGuard hat auf dieser Webseite {$numPopup} Pop-up-Fenster verhindert",
options:"Optionen",silence_noti:"Diese Nachricht auf {$origDomain} nicht anzeigen"},es:{userscript_name:"AdGuard Popup Blocker",on_navigation_by_popunder:"Parece que la transiciÃ³n a nueva pÃ¡gina sea causada por un pop-under (elemento emergente). Â¿Quiere continuar?",aborted_popunder_execution:"Popup Blocker cancelÃ³ la ejecuciÃ³n de un script para evitar la redirecciÃ³n en segundo plano",settings_saved:"Ajustes guardados",show_popup:"Mostrar {$destUrl}",continue_blocking:"Continuar bloqueando",allow_from:"Permitir ventanas emergentes en {$origDomain}",
manage_pref:"Administrar preferencias...",popup_text:"AdGuard impidiÃ³ que este sitio web abriera {$numPopup} ventanas emergentes",options:"Opciones",silence_noti:"No mostrar este mensaje en {$origDomain}"},fa:{userscript_name:"Ù…Ø³Ø¯ÙˆØ¯Ø³Ø§Ø² Ù¾Ø§Ù¾-Ø¢Ù¾ AdGuard",on_navigation_by_popunder:"Ø§Ù†ØªÙ‚Ø§Ù„ Ø¨Ù‡ Ø§ÛŒÙ† ØµÙØ­Ù‡ Ø¬Ø¯ÛŒØ¯ Ø§Ø­ØªÙ…Ø§Ù„Ø§ Ø¨Ø®Ø§Ø·Ø± ÛŒÙ‡ Ù¾Ø§Ù¾-Ø¢Ù†Ø¯Ø± Ø§Ù†Ø¬Ø§Ù… Ø´Ø¯Ù‡ Ø§Ø³Øª. Ù…ÛŒØ®ÙˆØ§Ù‡ÛŒØ¯ Ø§Ø¯Ø§Ù…Ù‡ Ø¯Ù‡ÛŒØ¯ØŸ",aborted_popunder_execution:"Ù…Ø³Ø¯ÙˆØ¯Ø³Ø§Ø² Ù¾Ø§Ù¾-Ø¢Ù¾ Ø§Ø¬Ø±Ø§ÛŒ Ú©Ø¯ Ø±Ø§ Ù„ØºÙˆ Ú©Ø±Ø¯Ù‡ ØªØ§ Ø§Ø² Ø±ÛŒØ¯Ø§ÛŒØ±Ú©Øª Ø¬Ø¨Ù„ÙˆÚ¯ÛŒØ±ÛŒ Ø´ÙˆØ¯",settings_saved:"ØªÙ†Ø¸ÙŠÙ…Ø§Øª Ø°Ø®ÛŒØ±Ù‡ Ø´Ø¯",show_popup:"Ù†Ù…Ø§ÛŒØ´ {$destUrl}",
continue_blocking:"Ø§Ø¯Ø§Ù…Ù‡ Ù…Ø³Ø¯ÙˆØ¯Ø³Ø§Ø²ÛŒ",allow_from:"Ø§Ø¬Ø§Ø²Ù‡ Ù¾Ø§Ù¾ Ø¢Ù¾ Ù‡Ø§ Ø¯Ø± {$origDomain}",manage_pref:"Ù…Ø¯ÛŒØ±ÛŒØª Ø§ÙˆÙ„ÙˆÛŒØª Ù‡Ø§...",popup_text:"AdGuard Ø§ÛŒÙ† ÙˆØ¨Ø³Ø§ÛŒØª Ø±Ø§ Ø§Ø² Ø¨Ø§Ø²Ú©Ø±Ø¯Ù† {$numPopup} Ù¾Ù†Ø¬Ø±Ù‡ Ù¾Ø§Ù¾ Ø¢Ù¾ Ø¬Ù„ÙˆÚ¯ÛŒØ±ÛŒ Ú©Ø±Ø¯",options:"Ú¯Ø²ÛŒÙ†Ù‡ Ù‡Ø§",silence_noti:"Ø§ÛŒÙ† Ù¾ÛŒØ§Ù… Ø±Ø§ Ù†Ø´Ø§Ù† Ù†Ø¯Ù‡ Ø¯Ø± {$origDomain}"},fi:{userscript_name:"AdGuardin Ponnahdusikkunan estÃ¤jÃ¤",aborted_popunder_execution:"Ponnahdusikkunoiden estÃ¤jÃ¤ keskeytti komentosarjan suorituksen estÃ¤Ã¤ksesi taustan uudelleenohjauksen",settings_saved:"Asetukset tallennettiin",show_popup:"NÃ¤ytÃ¤ {$destUrl}",
continue_blocking:"Jatka estÃ¤mistÃ¤",allow_from:"Salli ponnahdusikkunat sivustolle {$origDomain}",manage_pref:"Hallitse asetuksia...",popup_text:"AdGuard esti tÃ¤tÃ¤ verkkosivustoa avaamasta {$numPopup} ponnahdusikkunaa",options:"Vaihtoehdot",silence_noti:"Ã„lÃ¤ nÃ¤ytÃ¤ tÃ¤tÃ¤ viestiÃ¤ sivustolle {$origDomain}"},fr:{userscript_name:"Bloqueur de fenÃªtres pop-up de AdGuard",on_navigation_by_popunder:"Cette transition vers la nouvelle page est susceptible d'Ãªtre causÃ©e par un pop-under. DÃ©sirez-vous continuer?",
aborted_popunder_execution:"Le bloqueur de pop-ups a interrompu l'exÃ©cution d'un script pour empÃªcher une redirection en arriÃ¨re-plan",settings_saved:"ParamÃ¨tres sauvegardÃ©s",show_popup:"Afficher {$destUrl}",continue_blocking:"Continuer le blocage",allow_from:"Autoriser fenÃªtres pop-up pour {$origDomain}",manage_pref:"Administrer les prÃ©fÃ©rences...",popup_text:"AdGuard a empÃªchÃ© ce site web d'afficher {$numPopup} fenÃªtres pop-up",options:"Options",silence_noti:"Ne pas afficher ce message sur {$origDomain}"},
...
options:"Opsi",silence_noti:"Jangan tampilkan pesan ini di {$origDomain}"},it:{userscript_name:"Blocco Pop-Up di AdGuard",on_navigation_by_popunder:"Questo passaggio alla nuova pagina Ã¨ probabilmente causato da un pop-under. Vuoi continuare?",aborted_popunder_execution:"PopupBlocker ha interrotto l'esecuzione di uno script per impedire il reindirizzamento in background",settings_saved:"Impostazioni salvate",show_popup:"Mostra {$destUrl}",continue_blocking:"Continua a bloccare",allow_from:"Permetti popup per {$origDomain}",
manage_pref:"Gestisci opzioni",popup_text:"AdGuard ha impedito a questo sito web di aprire {$numPopup} finestre di popup",options:"Impostazioni",silence_noti:"Non mostrare questo messaggio in  {$origDomain}"},ja:{userscript_name:"AdGuard ãƒãƒƒãƒ—ã‚¢ãƒƒãƒ—ãƒ–ãƒ­ãƒƒã‚«ãƒ¼",on_navigation_by_popunder:"æ–°ã—ã„ãƒšãƒ¼ã‚¸ã¸ã®ç§»å‹•ã¯ãƒãƒƒãƒ—ã‚¢ãƒ³ãƒ€ãƒ¼ã«ã‚ˆã£ã¦ç”Ÿã˜ãŸå¯èƒ½æ€§ãŒã‚ã‚Šã¾ã™ã€‚ç¶šè¡Œã—ã¾ã™ã‹ï¼Ÿ",aborted_popunder_execution:"ãƒãƒƒãƒ—ã‚¢ãƒƒãƒ—ãƒ–ãƒ­ãƒƒã‚«ãƒ¼ã¯ãƒãƒƒã‚¯ã‚°ãƒ©ã‚¦ãƒ³ãƒ‰ãƒªãƒ€ã‚¤ãƒ¬ã‚¯ãƒˆã‚’é˜²ããŸã‚ã«ã‚¹ã‚¯ãƒªãƒ—ãƒˆã®å®Ÿè¡Œã‚’ä¸­æ­¢ã—ã¾ã—ãŸ",settings_saved:"è¨­å®šä¿å­˜å®Œäº†",show_popup:"{$destUrl}ã‚’è¡¨ç¤ºã™ã‚‹",continue_blocking:"ãƒ–ãƒ­ãƒƒã‚­ãƒ³ã‚°ã‚’ç¶šã‘ã‚‹",allow_from:"{$origDomain}ã®ãƒãƒƒãƒ—ã‚¢ãƒƒãƒ—ã‚’è¨±å¯ã™ã‚‹",
manage_pref:"è¨­å®šã‚’ç®¡ç†â€¦",popup_text:"AdGuardã¯ã“ã®ã‚¦ã‚§ãƒ–ã‚µã‚¤ãƒˆãŒ{$numPopup}ã®ãƒãƒƒãƒ—ã‚¢ãƒƒãƒ—ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã‚’é–‹ãã®ã‚’é˜²ãŽã¾ã—ãŸ",options:"ã‚ªãƒ—ã‚·ãƒ§ãƒ³",silence_noti:"{$origDomain}ã«ã“ã®ãƒ¡ãƒƒã‚»ãƒ¼ã‚¸ã‚’è¡¨ç¤ºã—ãªã„"},ko:{userscript_name:"AdGuard íŒì—… ì°¨ë‹¨ê¸°",on_navigation_by_popunder:"ì´ ìƒˆ íŽ˜ì´ì§€ë¡œì˜ ì´ë™ì€ íŒì–¸ë” ê´‘ê³ ì— ì˜í•œ ê²ƒì¼ ìˆ˜ ìžˆìŠµë‹ˆë‹¤. ê³„ì† í•˜ì‹œê² ìŠµë‹ˆê¹Œ?",aborted_popunder_execution:"íŒì—… ì°¨ë‹¨ê¸°ê°€ ë°±ê·¸ë¼ìš´ë“œ ë¦¬ë””ë ‰ì…˜ì„ ë°©ì§€í•˜ê¸° ìœ„í•´ ìŠ¤í¬ë¦½íŠ¸ ì‹¤í–‰ì„ ì¤‘ë‹¨í•˜ì˜€ìŠµë‹ˆë‹¤",settings_saved:"ì„¤ì • ì €ìž¥ë¨",show_popup:"{$destUrl} í‘œì‹œ",continue_blocking:"ê³„ì† ì°¨ë‹¨í•˜ê¸°",allow_from:"{$origDomain}ì˜ íŒì—… í—ˆìš©í•˜ê¸°",manage_pref:"í™˜ê²½ ì„¤ì • ê´€ë¦¬...",popup_text:"AdGuardê°€ ì´ ì›¹ì‚¬ì´íŠ¸ì—ì„œ {$numPopup}ê°œì˜ íŒì—… ì°½ì„ ì°¨ë‹¨í•˜ì˜€ìŠµë‹ˆë‹¤",
options:"ì˜µì…˜",silence_noti:"{$origDomain}ì—ì„œ ì´ ë©”ì„¸ì§€ í‘œì‹œí•˜ì§€ ì•Šê¸°"},lt:{userscript_name:"AdGuard iÅ¡Å¡okanÄiÅ³jÅ³ langÅ³ blokatorius",on_navigation_by_popunder:"Å is perÄ—jimas Ä¯ naujÄ… puslapÄ¯ greiÄiausiai buvo Ä¯takotas pop-under. Ar norite tÄ™sti?",aborted_popunder_execution:"IÅ¡kylanÄiÅ³ langÅ³ blokatorius nutraukÄ— skripto vykdymÄ…, kad bÅ«tÅ³ iÅ¡vengta foninio peradresavimo",settings_saved:"Nustatymai iÅ¡saugoti",show_popup:"Rodyti {$destUrl}",continue_blocking:"TÄ™sti blokavimÄ…",allow_from:"Leisti iÅ¡Å¡okanÄius langus {$origDomain}",
manage_pref:"Tvarkyti nuostatas...",popup_text:"â€žAdGuardâ€œ neleido Å¡iai svetainei atidaryti {$numPopup} iÅ¡Å¡okanÄius langus",options:"Parinktys",silence_noti:"Nerodyti Å¡io praneÅ¡imo {$origDomain}"},ms:{userscript_name:"AdGuard Penyekat Pop Timbul",on_navigation_by_popunder:"Peralihan ke laman baru ini kemungkinan disebabkan oleh pop-bawah. Anda ingin meneruskan?",aborted_popunder_execution:"Penyekat Pop Timbul menggugurkan pelaksanaan skrip bagi mengelakkan arah semula latar belakang",settings_saved:"Tetapan disimpan",
show_popup:"Tunjukkan {$destUrl}",continue_blocking:"Terus menyekat",allow_from:"Benarkan pop-timbul untuk {$origDomain}",manage_pref:"Urus keutamaan...",popup_text:"AdGuard menghalang laman web ini daripada membuka {$numPopup} tetingkap pop-timbul",options:"Pilihan",silence_noti:"Jangan tunjuk mesej ini pada {$origDomain}"},no:{userscript_name:"AdGuards popup-blokkerer",on_navigation_by_popunder:"Omdirigeringen til den nye nettsiden er sannsynligvis forÃ¥rsaket av en pop-under. Ã˜nsker du Ã¥ fortsette?",
aborted_popunder_execution:"Popup Blocker avbrÃ¸t en skrift fra Ã¥ kjÃ¸re for Ã¥ hindre bakgrunnsomdirigering",settings_saved:"Innstillinger lagret",show_popup:"Vis {$destUrl}",continue_blocking:"Fortsett blokkering",allow_from:"Tillat popup-vinduer for {$origDomain}",manage_pref:"Administrer preferanserâ€¦",popup_text:"AdGuard forhindret denne nettsiden i Ã¥ Ã¥pne popup-vinduer for {$numPopup}",options:"Alternativer",silence_noti:"Ikke vis denne meldingen for {$origDomain}"},pl:{userscript_name:"Bloker wyskakujÄ…cych okienek przez AdGuard",
on_navigation_by_popunder:"To przejÅ›cie na nowÄ… stronÄ™ moÅ¼e byÄ‡ spowodowane przez pop-under. Czy chcesz kontynuowaÄ‡?",aborted_popunder_execution:"Bloker wyskakujÄ…cych okienek przerwaÅ‚ wykonywanie skryptu, aby zapobiec przekierowaniu w tle",settings_saved:"Ustawienia zapisane",show_popup:"PokaÅ¼ {$destUrl}",continue_blocking:"Kontynuuj blokowanie",allow_from:"Zezwalaj na wyskakujÄ…ce okienka dla {$origDomain}",manage_pref:"ZarzÄ…dzaj preferencjami...",popup_text:"AdGuard zapobiegÅ‚ na tej stronie otwarcie  {$numPopup} wyskakujacego okienka.",
options:"Opcje",silence_noti:"Nie pokazuj tej wiadomoÅ›ci w {$origDomain}"},pt:{userscript_name:"AdGuard Bloqueador de Pop-ups",on_navigation_by_popunder:"Essa transiÃ§Ã£o para a nova pÃ¡gina provavelmente serÃ¡ causada por um pop-under. VocÃª deseja continuar?",aborted_popunder_execution:"O bloqueador de pop-ups interrompeu uma execuÃ§Ã£o de script para evitar um redirecionamento em segundo plano",settings_saved:"ConfiguraÃ§Ãµes salvas",show_popup:"Mostrar {$destUrl}",continue_blocking:"Continuar bloqueando",
allow_from:"Permitir pop-ups em {$origDomain}",manage_pref:"Gerenciar preferÃªncias...",popup_text:"O AdGuard impediu este site de abrir {$numPopup} pop-ups",options:"OpÃ§Ãµes",silence_noti:"NÃ£o mostrar essa mensagem no {$origDomain}"},"pt-PT":{userscript_name:"Bloqueador de Popup AdGuard",on_navigation_by_popunder:"Esta transiÃ§Ã£o para a nova pÃ¡gina  serÃ¡  provavelmente causada por um popunder. Deseja continuar?",aborted_popunder_execution:"PopupBlocker abortou uma execuÃ§Ã£o de script para evitar o redireccionamento em segundo plano",
settings_saved:"As definiÃ§Ãµes foram guardadas",show_popup:"Mostrar {$destUrl}",continue_blocking:"Continuar a bloquear",allow_from:"Permitir popups em {$origDomain}",manage_pref:"Gerir preferÃªncias...",popup_text:"O AdGuard impediu que este site abrisse janelas popup de {$numPopup}",options:"OpÃ§Ãµes",silence_noti:"NÃ£o mostrar esta mensagem em {$origDomain}"},ru:{userscript_name:"Ð‘Ð»Ð¾ÐºÐ¸Ñ€Ð¾Ð²Ñ‰Ð¸Ðº Ð²ÑÐ¿Ð»Ñ‹Ð²Ð°ÑŽÑ‰ÐµÐ¹ Ñ€ÐµÐºÐ»Ð°Ð¼Ñ‹ Ð¾Ñ‚ AdGuard",on_navigation_by_popunder:"Ð­Ñ‚Ð¾Ñ‚ Ð¿ÐµÑ€ÐµÑ…Ð¾Ð´ Ð½Ð° Ð½Ð¾Ð²ÑƒÑŽ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñƒ ÑÐºÐ¾Ñ€ÐµÐµ Ð²ÑÐµÐ³Ð¾ Ð²Ñ‹Ð·Ð²Ð°Ð½ Ð¿Ð¾Ð¿-Ð°Ð½Ð´ÐµÑ€Ð¾Ð¼. Ð’ÑÑ‘ Ñ€Ð°Ð²Ð½Ð¾ Ð¿Ñ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÑŒ?",
aborted_popunder_execution:"Ð‘Ð»Ð¾ÐºÐ¸Ñ€Ð¾Ð²Ñ‰Ð¸Ðº Ð²ÑÐ¿Ð»Ñ‹Ð²Ð°ÑŽÑ‰ÐµÐ¹ Ñ€ÐµÐºÐ»Ð°Ð¼Ñ‹ Ð¿Ñ€ÐµÑ€Ð²Ð°Ð» Ð¸ÑÐ¿Ð¾Ð»Ð½ÐµÐ½Ð¸Ðµ ÑÐºÑ€Ð¸Ð¿Ñ‚Ð°, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð¿Ñ€ÐµÐ´Ð¾Ñ‚Ð²Ñ€Ð°Ñ‚Ð¸Ñ‚ÑŒ Ñ„Ð¾Ð½Ð¾Ð²ÑƒÑŽ Ð¿ÐµÑ€ÐµÐ°Ð´Ñ€ÐµÑÐ°Ñ†Ð¸ÑŽ",settings_saved:"ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ñ‹",show_popup:"ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ {$destUrl}",continue_blocking:"ÐŸÑ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÑŒ Ð±Ð»Ð¾ÐºÐ¸Ñ€Ð¾Ð²ÐºÑƒ",allow_from:"Ð Ð°Ð·Ñ€ÐµÑˆÐ¸Ñ‚ÑŒ Ð²ÑÐ¿Ð»Ñ‹Ð²Ð°ÑŽÑ‰Ð¸Ðµ Ð¾ÐºÐ½Ð° Ð½Ð° {$origDomain}",manage_pref:"Ð£Ð¿Ñ€Ð°Ð²Ð»ÑÑ‚ÑŒ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ°Ð¼Ð¸...",popup_text:"AdGuard Ð¿Ñ€ÐµÐ´Ð¾Ñ‚Ð²Ñ€Ð°Ñ‚Ð¸Ð» Ð¿Ð¾ÐºÐ°Ð· {$numPopup} Ð²ÑÐ¿Ð»Ñ‹Ð²Ð°ÑŽÑ‰Ð¸Ñ… Ð¾ÐºÐ¾Ð½ Ð½Ð° ÑÑ‚Ð¾Ð¼ ÑÐ°Ð¹Ñ‚Ðµ",options:"ÐžÐ¿Ñ†Ð¸Ð¸",silence_noti:"ÐÐµ Ð¿Ð¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ ÑÑ‚Ð¾ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ðµ Ð½Ð° {$origDomain}"},sl:{userscript_name:"AdGuard Zaviralec pojavnih oken",
on_navigation_by_popunder:"Ta prehod na novo stran je verjetno posledica pojavnega okna. Ali Å¾elite nadaljevati?",aborted_popunder_execution:"Zaviralec pojavnih oken je prekinil izvajanje skripta, da bi prepreÄil preusmerjanje v ozadju",settings_saved:"Nastavitve so shranjene",show_popup:" PrikaÅ¾i {$destUrl}",continue_blocking:"Nadaljuj z zaviranjem",allow_from:"Dovoli pojavna okna na {$origDomain}",manage_pref:"Upravljaj nastavitve...",popup_text:"AdGuard je tej spletni strani prepreÄil odpiranje {$numPopup} pojavnih oken",
options:"MoÅ¾nosti",silence_noti:"Ne prikazuj tega sporoÄila na {$origDomain}"},tr:{userscript_name:"AdGuard Popup Blocker eklentisi",on_navigation_by_popunder:"Yeni sayfaya geÃ§iÅŸ, bir gizli pencere nedeniyle meydana gelmiÅŸ olabilir. Devam etmek istiyor musunuz?",aborted_popunder_execution:"Arka plan yÃ¶nlendirmesini Ã¶nlemek iÃ§in AÃ§Ä±lÄ±r Pencere Engelleyicisi bir komut dosyasÄ±nÄ±n Ã§alÄ±ÅŸmasÄ±nÄ± engelledi",settings_saved:"Ayarlar kaydedildi",show_popup:"{$destUrl} GÃ¶ster",continue_blocking:"Engellemeye devam et",
allow_from:"{$origDomain} iÃ§in aÃ§Ä±lÄ±r pencerelere izin ver",manage_pref:"Tercihleri yÃ¶net...",popup_text:"AdGuard bu sitenin {$numPopup} aÃ§Ä±lÄ±r pencere aÃ§masÄ±nÄ± Ã¶nledi",options:"Ayarlar",silence_noti:"Bu mesajÄ± {$origDomain} alan adÄ± Ã¼zerinde gÃ¶sterme"},uk:{userscript_name:"Ð‘Ð»Ð¾ÐºÑƒÐ²Ð°Ð»ÑŒÐ½Ð¸Ðº ÑÐ¿Ð»Ð¸Ð²Ð°ÑŽÑ‡Ð¾Ñ— Ñ€ÐµÐºÐ»Ð°Ð¼Ð¸ AdGuard",on_navigation_by_popunder:"Ð¦ÐµÐ¹ Ð¿ÐµÑ€ÐµÑ…Ñ–Ð´ Ð½Ð° Ð½Ð¾Ð²Ñƒ ÑÑ‚Ð¾Ñ€Ñ–Ð½ÐºÑƒ, Ð¹Ð¼Ð¾Ð²Ñ–Ñ€Ð½Ð¾, Ð¼Ñ–Ð³ Ð±ÑƒÑ‚Ð¸ Ð²Ð¸ÐºÐ»Ð¸ÐºÐ°Ð½Ð¸Ð¹ Ð¿Ð¾Ð¿-Ð°Ð½Ð´ÐµÑ€Ð¾Ð¼. Ð‘Ð°Ð¶Ð°Ñ”Ñ‚Ðµ Ð¿Ñ€Ð¾Ð´Ð¾Ð²Ð¶Ð¸Ñ‚Ð¸?",aborted_popunder_execution:"PopupBlocker Ð¿ÐµÑ€ÐµÑ€Ð²Ð°Ð² Ð²Ð¸ÐºÐ¾Ð½Ð°Ð½Ð½Ñ ÑÐºÑ€Ð¸Ð¿Ñ‚Ð°, Ñ‰Ð¾Ð± Ð·Ð°Ð¿Ð¾Ð±Ñ–Ð³Ñ‚Ð¸ Ñ„Ð¾Ð½Ð¾Ð²Ð¾Ð¼Ñƒ Ð¿ÐµÑ€ÐµÐ½Ð°Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð½ÑŽ",
settings_saved:"ÐÐ°Ð»Ð°ÑˆÑ‚ÑƒÐ²Ð°Ð½Ð½Ñ Ð·Ð±ÐµÑ€ÐµÐ¶ÐµÐ½Ñ–",show_popup:"ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚Ð¸ {$destUrl}",continue_blocking:"ÐŸÑ€Ð¾Ð´Ð¾Ð²Ð¶Ð¸Ñ‚Ð¸ Ð±Ð»Ð¾ÐºÑƒÐ²Ð°Ð½Ð½Ñ",allow_from:"Ð”Ð¾Ð·Ð²Ð¾Ð»Ð¸Ñ‚Ð¸ ÑÐ¿Ð»Ð¸Ð²Ð°ÑŽÑ‡Ñ– Ð²Ñ–ÐºÐ½Ð° {$origDomain}",manage_pref:"ÐšÐµÑ€ÑƒÐ²Ð°Ñ‚Ð¸ Ð½Ð°Ð»Ð°ÑˆÑ‚ÑƒÐ²Ð°Ð½Ð½ÑÐ¼Ð¸...",popup_text:"AdGuard Ð·Ð°Ð¿Ð¾Ð±Ñ–Ð³ Ð¿Ð¾ÐºÐ°Ð·Ñƒ {$numPopup} ÑÐ¿Ð»Ð¸Ð²Ð°ÑŽÑ‡Ð¸Ñ… Ð²Ñ–ÐºÐ¾Ð½ Ð½Ð° Ñ†ÑŒÐ¾Ð¼Ñƒ ÑÐ°Ð¹Ñ‚Ñ–",options:"ÐžÐ¿Ñ†Ñ–Ñ—",silence_noti:"ÐÐµ Ð¿Ð¾ÐºÐ°Ð·ÑƒÐ²Ð°Ñ‚Ð¸ Ñ†Ðµ Ð¿Ð¾Ð²Ñ–Ð´Ð¾Ð¼Ð»ÐµÐ½Ð½Ñ Ð½Ð° {$origDomain}"},vi:{userscript_name:"AdGuard Popup Blocker",on_navigation_by_popunder:"Viá»‡c chuyá»ƒn Ä‘á»•i sang trang má»›i nÃ y cÃ³ thá»ƒ Ä‘Æ°á»£c gÃ¢y ra bá»Ÿi má»™t cá»­a sá»• báº­t xuá»‘ng. Báº¡n cÃ³ muá»‘n tiáº¿p tá»¥c?",
aborted_popunder_execution:"TrÃ¬nh cháº·n Popup Ä‘Ã£ há»§y bá» viá»‡c thá»±c thi táº­p lá»‡nh Ä‘á»ƒ ngÄƒn chuyá»ƒn hÆ°á»›ng ná»n",settings_saved:"ÄÃ£ lÆ°u cÃ i Ä‘áº·t",show_popup:"Hiá»‡n {$destUrl}",continue_blocking:"Tiáº¿p tá»¥c cháº·n",allow_from:"Cho phÃ©p cá»­a sá»• báº­t lÃªn cho {$origDomain}",manage_pref:"Quáº£n lÃ½ tÃ¹y chá»n...",popup_text:"AdGuard Ä‘Ã£ ngÄƒn trang web nÃ y má»Ÿ {$numPopup} cá»­a sá»• báº­t lÃªn",options:"Tuá»³ chá»n",silence_noti:"Äá»«ng hiá»ƒn thá»‹ thÃ´ng bÃ¡o nÃ y trÃªn {$origDomain}"},zh:{userscript_name:"AdGuard å¼¹çª—æ‹¦æˆªå™¨",on_navigation_by_popunder:"æ­¤ç½‘é¡µå¯¼èˆªå¯èƒ½å¯¼è‡´å¼¹çª—ã€‚æ‚¨è¦ç»§ç»­ï¼Ÿ",
aborted_popunder_execution:"PopupBlocker å·²ä¸­æ­¢è„šæœ¬æ‰§è¡Œä»¥é˜²æ­¢åŽå°é‡æ–°å®šå‘",settings_saved:"è®¾ç½®å·²ä¿å­˜",show_popup:"æ˜¾ç¤º {$destUrl}",continue_blocking:"ç»§ç»­æ‹¦æˆª",allow_from:"å…è®¸ {$origDomain} å¼¹çª—",manage_pref:"ç®¡ç†é¦–é€‰é¡¹...",popup_text:"AdGuard å·²é˜²æ­¢æ­¤ç½‘ç«™æ‰“å¼€çš„ {$numPopup} ä¸ªå¼¹çª—",options:"é€‰é¡¹",silence_noti:"åœ¨ {$origDomain} ä¸Šä¸å†æ˜¾ç¤ºæ­¤è®¯æ¯"},"zh-TW":{userscript_name:"AdGuard å½ˆå‡ºå¼è¦–çª—å°éŽ–å™¨",on_navigation_by_popunder:"æ­¤è‡³æ–°çš„é é¢ä¹‹è½‰æ›å¾ˆå¯èƒ½æ˜¯ç”±ä¸€å€‹èƒŒå½ˆå¼è¦–çª—å¼•èµ·ã€‚æ‚¨æƒ³è¦ç¹¼çºŒå—Žï¼Ÿ",aborted_popunder_execution:"å½ˆå‡ºå¼è¦–çª—å°éŽ–å™¨å·²ä¸­æ­¢è…³æœ¬åŸ·è¡Œä»¥é˜²æ­¢èƒŒæ™¯é‡æ–°å°Žå‘",settings_saved:"è¨­å®šè¢«å„²å­˜",show_popup:"é¡¯ç¤º {$destUrl}",continue_blocking:"ç¹¼çºŒå°éŽ–",
allow_from:"å…è¨±åœ¨ {$origDomain} çš„å½ˆå‡ºå¼è¦–çª—",manage_pref:"ç®¡ç†åå¥½è¨­å®šâ€¦",popup_text:"AdGuard å·²é˜²æ­¢è©²ç¶²ç«™é–‹å•Ÿ {$numPopup} å½ˆå‡ºå¼è¦–çª—",options:"é¸é …",silence_noti:"ä¸è¦æ–¼ {$origDomain} ä¸Šé¡¯ç¤ºè©²è¨Šæ¯"}},Ed=Object.keys(Dd).map(function(a){return a.replace("_","-")}),Fd=null;function Gd(a){return-1!==Ed.indexOf(a)?(Fd=a,!0):!1}if("undefined"===typeof AdguardSettings||!Gd(AdguardSettings.locale.replace("_","-"))){var Y=navigator.language.replace("_","-");if(!Gd(Y)){var Hd=Y.indexOf("-");-1!==Hd&&(Y=Y.slice(0,Hd));Gd(Y)||(Fd="en")}}
